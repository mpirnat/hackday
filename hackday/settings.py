...
DATABASES = {
    'default': {
        ...
        'NAME': VENV_ROOT+'/db/hackday.db',     # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(CODE_ROOT, 'static_collection')
...
SECRET_KEY = '-r3#vts8a@n)yrjv1l9m+o8g2#nu^!+&0t30la@iy&%c1lf6nk'
